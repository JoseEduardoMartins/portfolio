      ...
      <footer className={style.repository_footer}>
        ...
        <div className={style.repository_footer_counts}>
          <div className={style.repository_footer_count}>
            ...
            <div className={style.repository_footer_count_label}>stars</div>
          </div>
          <div className={style.repository_footer_count}>
            <Icon size="small">eye</Icon>
            {repository.watchers_count}
            <div className={style.repository_footer_count_label}>watching</div>
          </div>
          <div className={style.repository_footer_count}>
            <Icon size="small">fork</Icon>
            {repository.forks_count}
            <div className={style.repository_footer_count_label}>forks</div>
          </div>
        </div>
      </footer>
    </Box>
