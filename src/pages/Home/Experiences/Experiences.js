...
const experiences = [
    {
        ...
        description: "Desenvolvimento de uma ferramenta ágil de recrutamento em prol de melhorar a experiência do usuário recrutador e recrutado. Funcionalidades de construção relacionadas a api´s de entidade, autenticação, regras de negocio do sistema, componentes React e funcionalidades dentro do Front-end utilizando as tecnologias node.js, typescript, React, MySQL workbench entre outras tecnologias do mercado.",
        skils: [
...
const Experiences = () => {
  ...
  const changeOpenExperience = (number) => setOpenExperience((openExperience === number) ? undefined : number);
